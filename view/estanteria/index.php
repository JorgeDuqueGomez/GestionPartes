...
<div class="container">
  ...
  <br>
  <table class="table table-bordered mx-auto" id="gestionEstanteriaTable">
    <thead class="table-light">
      <tr>
        ...
        <th class="text-center align-middle" scope="col">Orden de<br>alistamiento</th>
    ...
    <tbody>
      <?php if ($rows) : ?>
        <?php foreach ($rows as $row) : ?>
          <tr>
            <th class="text-center align-middle"><?= $row[2] ?> - <?= $row[3] ?></th>
            ...
            <th class="text-center">
              ...
              <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="setDeleteId('<?= $row[0] ?>')"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
