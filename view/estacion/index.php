...
<div class="container">
  <div class="d-flex justify-content-center">
    <a href="./creat.php">
      <button type="button" class="btn btn-primary d-flex align-items-center" type="button"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-plus-circle-fill" viewBox="0 0 16 16">
        ...
        </svg>&nbsp;Agregar nueva estacion</button>
    </a>
  </div>
  <br>
  <script>
    $(document).ready(function() {
      $('#estacionTable').DataTable({
        ...
        "autoWidth": true,
        "columnDefs": [{
          "targets": 4, // Índice de la segunda columna (comienza en 0)
          "width": "100px",
          "max-width": "100px"
        }],
      });
  ...
  <div class="table-responsive">
    <table class="table table-bordered table-hover" style="max-width: 50%;" id="estacionTable">
          ...
          <?php foreach ($rows as $row) : ?>
            <tr>
              ...
              <th class="text-center">
                ...
                <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="setDeleteId('<?= $row['idEstacion'] ?>')">
