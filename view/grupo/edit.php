...
<div class="container">
    ...
    <div class="mb-3 row">
            <label class="col-sm-2 col-form-label text-end">ID Grupo</label>
            <div class="col-sm-3">
        ...
        <div class="mb-3 row">
            <label class="col-sm-2 col-form-label text-end">Codigo del grupo</label>
            <div class="col-sm-3">
        ...
        <div class="mb-3 row">
            <label class="col-sm-2 col-form-label text-end">Nombre del grupo</label>
            <div class="col-sm-3">
