...
<div class="container">
  ...
  <table class="table table-bordered mx-auto" style="max-width: 40%;" id="estacionTable">
        ...
        <?php foreach ($rows as $row) : ?>
          <tr>
            ...
            <th class="text-center">
              ...
              <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="setDeleteId('<?= $row[0] ?>')">
